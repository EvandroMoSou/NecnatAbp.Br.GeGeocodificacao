...
public class GeGeocodificacaoWebHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public GeGeocodificacaoWebHostMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<GeGeocodificacaoResource>();
