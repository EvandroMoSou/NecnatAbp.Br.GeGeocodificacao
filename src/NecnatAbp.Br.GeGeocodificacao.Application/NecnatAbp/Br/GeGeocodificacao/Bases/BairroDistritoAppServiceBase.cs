...
namespace NecnatAbp.Br.GeGeocodificacao
{
    public abstract class BairroDistritoAppServiceBase<
        ...
        CrudsAppService<
            ...
            TCreateUpdateBairroDistritoDto,
            TBairroDistritoResultRequestDto>,
        IBairroDistritoAppServiceBase<TBairroDistritoDto, TCreateUpdateBairroDistritoDto, TBairroDistritoResultRequestDto, TBairroDistritoFallbackResultRequestDto, TSubdistritoDto>
    ...
    {
        protected IBairroDistritoRepositoryBase<TBairroDistrito, TCidadeMunicipio> TypedRepository { get; }
        protected ISubdistritoRepositoryBase<TBairroDistrito, TCidadeMunicipio, TSubdistrito> SubdistritoRepository { get; }

        public BairroDistritoAppServiceBase(IBairroDistritoRepositoryBase<TBairroDistrito, TCidadeMunicipio> repository, ISubdistritoRepositoryBase<TBairroDistrito, TCidadeMunicipio, TSubdistrito> subdistritoRepository) : base(repository)
        {
        ...
        /// </summary>
        protected override async Task<IQueryable<TBairroDistrito>> CreateFilteredQuerySearchAsync(TBairroDistritoResultRequestDto input)
        {
        ...
        public async Task<List<TBairroDistritoDto>> SearchFallbackSubdistritoAsync(TBairroDistritoFallbackResultRequestDto input)
        {
            ...
            if (input.GenericSearch.All(char.IsDigit))
            {
                if (input.GenericSearch.Length == 9)
                {
                    ...
                    if (e == null)
                        return new List<TBairroDistritoDto>();
                    else
                        return new List<TBairroDistritoDto> { MapToGetListOutputDto(e) };
                }
            ...
            var l = new List<TBairroDistritoDto>();
        ...
        protected TBairroDistritoDto MapToGetListOutputDto(TSubdistrito entity)
        {
            var dto = MapToGetListOutputDto(entity.BairroDistrito!);
            dto.Subdistrito = ObjectMapper.Map<TSubdistrito, TSubdistritoDto>(entity);
