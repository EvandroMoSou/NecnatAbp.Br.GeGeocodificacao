...
{
    public abstract class PaisAppServiceBase<TPais, TPaisDto, TCreateUpdatePaisDto, TPaisResultRequestDto> :
        CrudsAppService<
            TPais,
            TPaisDto,
            Guid,
        ...
        where TPaisResultRequestDto : PaisResultRequestDtoBase
    {
        ...
        /// </summary>
        protected override async Task<IQueryable<TPais>> CreateFilteredQuerySearchAsync(TPaisResultRequestDto input)
        {
