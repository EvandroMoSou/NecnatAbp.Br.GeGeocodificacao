...
{
    //public class IbgeDtbDataSeederContributor : IDataSeedContributor, ITransientDependency
    //{
    //    private const int _massaTeste = 1000; // TODO: Apagar
    //    private const bool _force = false;
    //    private const string _municipioResourceName = "Necnat.Geocodificacao.DataSeed.IbgeDtb.Date2022.RELATORIO_DTB_BRASIL_MUNICIPIO.csv";
    //    private const string _distritoResourceName = "Necnat.Geocodificacao.DataSeed.IbgeDtb.Date2022.RELATORIO_DTB_BRASIL_DISTRITO.csv";
    //    private const string _subdistritooResourceName = "Necnat.Geocodificacao.DataSeed.IbgeDtb.Date2022.RELATORIO_DTB_BRASIL_SUBDISTRITO.csv";
    ...
    //                                if (eDbSearch != null && eDbSearch.OrigemRegistro != OrigemRegistro.Ibge)
    //                                    eDb = eDbSearch;
    //                            }
    ...
    //                            eDb.Nome = nome;
    //                            eDb.Ativo = true;
    //                            eDb.OrigemRegistro = OrigemRegistro.Ibge;
